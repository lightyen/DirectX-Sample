...
namespace DirectX {
	...
	Exception::Exception(HRESULT result, LPCTSTR funcName) noexcept {
		this->result = result;
	...
	GraphicsException::GraphicsException(HRESULT result, LPCTSTR func)
		: Exception(result, func) {
		ShowMessage();
	}

	void GraphicsException::ShowMessage() noexcept {
